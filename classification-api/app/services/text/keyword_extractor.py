...
class KeyWordExtractor:
    ...
    def extract_keywords(self, text, topic_keywords):
      ...
      #  entities = self.__extract_all_entities_with_lexemes(text)
       # keywords_from_entities = self.__find_all_keywords_with_entities(topic_keywords, entities)
        #extracted_keywords = keywords_from_phrases.union(keywords_from_entities)
    # Load a multilingual model that supports Ukrainian
